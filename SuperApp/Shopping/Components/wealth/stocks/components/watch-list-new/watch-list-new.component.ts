...
// import { NotificationpagePage } from '../../notificationpage/notificationpage.page';
...
// import { NotificationFilterComponent } from '../../notificationpage/notification-filter/notification-filter.component';
...
export class WatchListNewComponent implements OnInit {
  ...
  getWatchListArray() {
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.getWatchList, param)
    .subscribe(async (res: any) =>{
      ...
      console.log(this.watchlistData,'gdfhsdghksdgjkdsf');
  ...
  fundLimitDetailed() {
   ...
   this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.getFundLimit, param)
    .subscribe(async (res: any) => {
        if (!this.CurrentFund) {
          this.CurrentFund = 0;
        }
  ...
  //     let objIndex = this.watchlistData.findIndex((obj) => {watchlistDatawatc
  ...
  getWatchListData() {
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.getList + "?getWatchList", param)
    .subscribe(async (res: any) => {
        {
          ...
          console.log(this.watchlistData,'watc');
  ...
  async openStockDetails(val) {
    console.log("mfnvmn  njknvjn",val);
