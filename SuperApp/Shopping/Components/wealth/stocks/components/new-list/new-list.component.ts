...
export class NewListComponent implements OnInit {
  ...
  ToggleImg(val) {
    ...
    if (this.selectedStock.includes(val.SEC_ID)) {
      ...
      this.http.post('https://aqapicug.rsec.co.in/api/v1/wealth/stock/Mpost/AddMktWatchList', param).subscribe(async (res: any) => {
        console.log(res);
  ...
  getStockData() {
    ...
    this.http.post("https://aqapicug.rsec.co.in/api/v1/wealth/stock/Mpost/GetWatchListDetails", data).subscribe(
      (res: any) => {
