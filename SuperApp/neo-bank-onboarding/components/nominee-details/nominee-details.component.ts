...
export class NomineeDetailsComponent implements OnInit {
  ...
  insertNomineeDetailsPost(obj){
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.neoAddNominee, obj)
  ...
  processNomineePostData() {
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.neoAddNominee, {})
    .subscribe((data: any) => {
      this.loaderService.hideLoader();
      if (data && data?.Status) {
