...
this.router.navigate(['/Engagement/EngagementFaqs/productWiseList'],{state:{Header: val}})
...
this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.getFaq,params).subscribe(
  (data: any) => {
...
this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.globalSearch,prams).subscribe(
  (data: any) => {
