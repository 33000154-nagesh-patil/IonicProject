...
export class EsignComponent implements OnInit {
  ...
  constructor(private router: Router,private modalController: ModalController,
    private domSanitizer: DomSanitizer, private allConfigDataService: AllConfigDataService,
    private loaderService: LoaderService, private loadingController: LoadingController,
    private commonService: CommonService, private commonFunctionService: CommonFunctionService,
    private networkService: NetworkService, private http: HttpClient,
  ...
  ngOnInit() {
    ...
    this.breadCrumb='Onboarding/OnboardingSteps/Esign';
  ...
  async esignPDFPreveiw() {
    this.onboardingService.nextOnSuccess('eSign');
    return;
    // setTimeout(() => {
    ...
    if (this.currentNativeNetwork) {
      ...
      this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.getEsignPdf, headers)
  ...
  processToNSDL() {
    ...
    .subscribe(
      (data: any) => {
        ...
        // this.router.navigate(['/Onboarding'+data['pageUrl']]);
          this.safeUrl = this.domSanitizer.bypassSecurityTrustResourceUrl(data.FinalUrl)
  ...
  processESignPostData() {
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.addPdfDetailForEsign, localPostData)
  ...
  exporeApp() {
    ...
    // this.processESignPostData()
    // this.router.navigate(['/Onboarding'+this.navigateUrl]);
    if(localStorage.getItem('userType') == 'Partner'){
      // this.processESignPostData();
      // this.onboardingService.nextOnSuccess('AadharEsign');
