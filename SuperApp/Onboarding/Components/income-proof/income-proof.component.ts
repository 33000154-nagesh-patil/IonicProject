...
export class IncomeProofComponent implements OnInit {
  ...
  continue() {
    ...
    this.params = {
      ...
      'IncomeProofImage': this.incomeProoftest,
      // 'IncomeProofGuId': this.incomeProofKYC.DocumentGuId,
      'IncomeProof': this.incomeProofForm.value.incomeProofDetails,
  ...
  insertProofDetails(obj) {
    ...
    this.http.post(this.apiCatalog.baseURL[this.apiCatalog.environment]+this.apiCatalog.breadCrumb+this.apiCatalog.incomeProofDocumentUpload, obj)
