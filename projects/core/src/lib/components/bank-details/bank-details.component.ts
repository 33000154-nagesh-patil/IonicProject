...
import { ChequeOcrResponse, panDetails } from '../../interfaces/common.interface';
...
export class BankDetailsComponent implements OnInit {
  ...
  processToNextStep(obj) {
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.BankAccountValidation, obj)
    .subscribe((data: any) => {
      this.loaderService.hideLoader();
      if (true) {
  ...
  getPanNameMatch(obj, bankData): any {
    ...
    this.http.post(this.apiCatalog.baseURL[this.appEnviron]+this.breadCrumb+this.apiCatalog.panNameMatch, obj)
