...
// import { TcsStock } from '../../lib/tcsStock';
import { TcsStock } from 'projects/wealth-wellness/src/lib/lib/tcsStock';

@Component({
  selector: 'app-wealth-dashbord',
  templateUrl: './wealth-dashbord.component.html',
  styleUrls: ['./wealth-dashbord.component.scss'],
})
export class WealthDashbordComponent implements OnInit {
  title = "Stocks";
  textName = "Stocks"
  imageList: any;
  stocksTab:any
